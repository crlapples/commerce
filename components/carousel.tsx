...
export async function Carousel() {
  ...
  return (
    <span className="w-[580vw] md:w-[274vw] flex overflow-x-hidden gap-[8px]">
      <span className={`${styles.a} w-[290vw] md:w-[137vw] flex overflow-x-scroll gap-[8px] px-1 pb-6 pt-1`}>
